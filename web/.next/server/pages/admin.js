...
module.exports = __webpack_require__("wbZ2");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Page", function() { return /* binding */ Page; });
...
// CONCATENATED MODULE: ./src/hooks/useIsAuthed.ts
...
/* harmony default export */ var hooks_useIsAuthed = (Object(withApolloHook["a" /* withApollo */])({
  ssr: true
})(useIsAuthed));
...
function Page() {
  useIsAuthed(); // useIsAuth()

  return /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
    children: "Hello earthling"
  });
}
/* harmony default export */ var admin = __webpack_exports__["default"] = (Object(withApolloHook["a" /* withApollo */])({
  ssr: true
})(Page));
